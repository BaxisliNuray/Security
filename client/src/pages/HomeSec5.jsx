        ...
        <div style={{ padding: '50px 0px' }}>
            <Container>
                ...
                <Box sx={{ flexGrow: 1 }}>
                    <Grid container>
                        <Grid item xs={6} md={7}>
                            <img src="https://preview.colorlib.com/theme/security/img/g1.jpg" alt="" />
                        </Grid>
                        <Grid item xs={6} md={5}>
                            <img src="https://preview.colorlib.com/theme/security/img/g2.jpg" alt="" />
                        </Grid>
                        <Grid item xs={6} md={4}>
                        <img src="	https://preview.colorlib.com/theme/security/img/g3.jpg" alt="" />
                        </Grid>
                        <Grid item xs={6} md={4}>
                            <img src="https://preview.colorlib.com/theme/security/img/g4.jpg" alt="" />
                        </Grid>
                        <Grid item xs={6} md={4}>
                            <img src="https://preview.colorlib.com/theme/security/img/g5.jpg.webp" alt="" />
                        </Grid>
                        <Grid item xs={6} md={5}>
                            <img src="https://preview.colorlib.com/theme/security/img/g6.jpg" alt="" />
                        </Grid>
                        <Grid item xs={6} md={7}>
                            <img src="https://preview.colorlib.com/theme/security/img/g7.jpg" alt="" />
                        </Grid>
                    </Grid>
                </Box>
            </Container>
